...
const FlashErrorProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  return <FlashErrorContext.Provider value={{ error, setError, clearError }}>{children}</FlashErrorContext.Provider>;
};
