...
import { Box, Container, Grid, Typography, Button, SvgIcon, Input, List, ListItem, CardMedia, Stack, Divider } from '@mui/material';
            ...
            <Box display="flex" alignItems="center" height="100%">
              <Box width="100%" maxWidth="xl">
                ...
                <Box display="flex" alignItems="center" mb={2}>
                  <Typography variant="h6" component="span" sx={{ fontWeight: 'bold' }} pr={5} borderRight={1} borderColor="grey.300">
                    ${product?.price}
                  </Typography>
                  <Box display="flex" alignItems="center" ml={2}>
                    {[...Array(5)].map((_, index) => (
                      <SvgIcon key={index} viewBox="0 0 20 20" sx={{ width: 20, height: 20 }}>
                        <path
