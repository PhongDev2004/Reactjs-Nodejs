      ...
      <Container maxWidth="lg" sx={{ my: 5 }}>
        <Grid container spacing={2}>
                ...
                <TableBody>
                  {products.map((product, index) => (
                    <TableRow key={index}>
                      ...
                      <TableCell align="left">
                        <DeleteIcon onClick={() => handleRemove(product.productId._id)} fontSize="small" sx={{ color: '#B88E2F' }} />
                      </TableCell>
                    </TableRow>
                  ))}
                </TableBody>
          ...
          <Grid item xs={12} md={4}>
            ...
            >
              <Typography variant="h5" mb={5} py={2} fontWeight={700}>
                Cart Total
              </Typography>
              <Typography variant="body1" display="flex" width="100%" fontWeight={600}>
                Subtotal:{' '}
                <Typography ml="auto" component="span" color="#9F9F9F">
                  Rs. {calculateTotalPrice()}
                </Typography>
              </Typography>
              <Typography variant="body1" display="flex" alignItems="center" my={4} width="100%" fontWeight={600}>
                Total:{' '}
                <Typography ml="auto" component="span" fontWeight={700} variant="h6" color="#B88E2F">
                  Rs. {calculateTotalPrice()}
                </Typography>
              </Typography>
              <Link to="/checkout">
                <Button variant="outlined" color="inherit" sx={{ color: '#000', transform: 'initial', mb: 8 }}>
                  Check Out
                </Button>
              </Link>
            </Box>
