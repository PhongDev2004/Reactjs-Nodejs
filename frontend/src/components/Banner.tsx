...
const Banner = () => {
  return (
    <section className="max-w-[2520px] mx-auto xl:px-20 md:px-10 sm:px-2 px-4 mt-8">
      <div
        className="md:h-[500px] w-full bg-top bg-cover rounded-3xl flex flex-col md:flex-row p-8"
      ...
      >
        <div className="basis-1/2 flex justify-center flex-col px-4">
          ...
          <p className="text-slate-600 font-light text-sm line-clamp-3">
            ...
            Perspiciatis voluptatem, beatae amet libero ex sapiente officia
            eaque neque ipsum eveniet dolores obcaecati ullam pariatur provident
            totam cumque ut nihil, itaque nam quidem, voluptas aliquam.
          </p>
          <button className="rounded-full mt-6 md:max-w-[50%] bg-slate-700 hover:bg-slate-800 py-2 text-white">
            Shopping now!
          </button>
        </div>
